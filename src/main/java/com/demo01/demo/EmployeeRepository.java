...
public interface EmployeeRepository extends PagingAndSortingRepository<Employee, Long> , CustomizedEmployeeRepository{

    /*a PagingAndSortingRepository interface és az ősei elég sok metódust tartalmaznak alapból, de ha ez nem lenne elég...*/
